...
from src.tools.valuation_calc import DCFValuationTool, MultiplesValuationTool, ValuationComparisonTool
...
def create_agent6() -> Agent:
    return Agent(
        ...
        tools=[DCFValuationTool(), MultiplesValuationTool(), ValuationComparisonTool(), MarkdownReadTool()],
