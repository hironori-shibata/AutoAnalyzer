...
from src.tools.valuation_calc import DCFValuationTool, MultiplesValuationTool, ValuationComparisonTool, SOTPValuationTool
...
def create_agent6() -> Agent:
    return Agent(
        ...
        backstory=(
            ...
            "DCFの計算は必ず DCFValuationTool を、マルチプルの計算は必ず MultiplesValuationTool を使うこと。"
        ),
        tools=[DCFValuationTool(), MultiplesValuationTool(), ValuationComparisonTool(), SOTPValuationTool(), MarkdownReadTool()],
